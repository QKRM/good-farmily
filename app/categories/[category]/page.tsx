...
// Image mapping for category headers
const categoryImages = {
  chicken: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/chicken-TEeWogsaE4jkWRwAIB3U9mVU8o6GzF.png",
  cow: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/cow-ew7jp7OHOM6ovyaI7Iw8gomE5YnRY3.png",
  goat: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/goat-mWLlJ6neUa8muMzEgOulEeEyMdBraE.png",
  pig: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pig-n7115X5aYXeRypEsiAxyZht7lKWzqY.png",
}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center">
            ...
            <div className="w-full md:w-2/3 text-center md:text-left">
              <h1 className="text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl">{categoryTitle}</h1>
            </div>
          </div>
        </div>
      </header>
